...
class ChefUserAcceptedDetail extends StatefulWidget {
  ChefUserAcceptedDetail({Key key}) : super(key: key);

  @override
  _ChefUserAcceptedDetail createState() => _ChefUserAcceptedDetail();
}

class _ChefUserAcceptedDetail extends State<ChefUserAcceptedDetail> {
