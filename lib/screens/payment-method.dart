...
class _PaymentMethodPage extends State<PaymentMethod> {
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: TextButton(
                            ...
                            onPressed: () {Navigator.pushReplacementNamed(context, '/voucher-add-payment');},
                          ),
                        )
                      ],
                    ),
                    ...
                    child: Column(
                      children: [
                        ...
                        Row(
                          children: [
                            Radio(
                              groupValue: method == "zalopay" ? true : false,
                              value: true,
                              onChanged: (value) {
                                setState(() {
                                  method = "zalopay";
                            ...
                            Container(
                              ...
                              height: 50,
                              child: Image.network(
                                'https://img.websosanh.vn/v2/users/financial/images/ypa8r8jf575ck.jpg?compress=85',
                                fit: BoxFit.cover,
                              ),
                            ),
                            SizedBox(
                        ...
                        Row(
                          children: [
                            Radio(
                              groupValue: method == "momo" ? true : false,
                              value: true,
                              onChanged: (value) {
                                setState(() {
                                  method = "momo";
                            ...
                            Container(
                              ...
                              height: 50,
                              child: Image.network(
                                'https://www.vaytaichinh.vn/wp-content/uploads/2020/05/nen-su-dung-vi-dien-tu-nao-vi-dien-tu-momo.jpg',
                                fit: BoxFit.cover,
                              ),
                            ),
                            SizedBox(
