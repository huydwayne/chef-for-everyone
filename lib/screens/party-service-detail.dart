...
class PartyServiceDetail extends StatefulWidget {
  PartyServiceDetail({Key key}) : super(key: key);

  @override
  _PartyServiceDetailPage createState() => _PartyServiceDetailPage();
}

class _PartyServiceDetailPage extends State<PartyServiceDetail> {
          ...
          slivers: [
            SliverAppBar(
              ...
              leading: IconButton(
                ...
                onPressed: () {
                  Navigator.pushReplacementNamed(context, '/party-service');
                },
              ),
            ),
            SliverList(
                        ...
                        Container(
                          child: Row(
                            children: [
                              Container(
                                height: 35,
                                padding: EdgeInsets.fromLTRB(16, 15, 29, 0),
                                child: Text(
                                  'Số người:',
                                  style: TextStyle(
                                    fontSize: 15,
                            ...
                            Text(
                              () {
                                if (total == 0) {
                                  ...
                                  return NumberFormat("#,###", "en_US").format(
                                      size == "big" ? total * 1.5 : total);
                                }
                              }(),
                              style: TextStyle(color: Colors.black),
                            )
