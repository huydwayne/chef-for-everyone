...
class BookedCardWithRating extends StatefulWidget {
  BookedCardWithRating({Key key}) : super(key: key);

  @override
  _BookedCardWithRatingPage createState() => _BookedCardWithRatingPage();
}

class _BookedCardWithRatingPage extends State<BookedCardWithRating> {
